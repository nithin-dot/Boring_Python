...
words_to_remove = ["yuumeiArt.com"]
pytesseract.pytesseract.tesseract_cmd = r"C:/Users/nithin/AppData/Local/Tesseract-OCR/tesseract.exe"

image = cv2.imread("C:/Users/nithin/Desktop/temp/image/temp.jpg")
